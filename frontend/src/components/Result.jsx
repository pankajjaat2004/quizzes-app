            ...
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center">
                    <div className="col-lg-6">
                        <div className={`text-light text-center p-5 rounded ${marks >= (quizs.length-4) ? 'bg-success' : 'bg-danger'}`}>
                            <h1 className='mb-2 fw-bold'>{marks >= (quizs.length-4) ? (marks === (quizs.length) ? 'Awesome!':'Great') : 'Oops!'}</h1>
